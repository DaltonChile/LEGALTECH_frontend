...
export function AdminDashboard() {
  ...
  const { dateRange, getApiParams, refreshKey } = useDateRange();
      ...
      <div className="p-6 md:p-8">
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
            ...
            <Box variant="document" padding="md" className="md:col-span-8">
              <div className="mb-6">
                <Text variant="h4" className="flex items-center gap-2">
            ...
            <Box variant="document" padding="md" className="md:col-span-4">
              <div className="mb-4">
                <Text variant="h4" className="flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
            ...
            <Box variant="document" padding="none" className="md:col-span-8 overflow-hidden">
            ...
            <Box variant="document" padding="none" className="md:col-span-4 overflow-hidden">
