...
export function CapsuleSelector({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
      ...
      <div className="border-t border-slate-100 w-full p-4 space-y-2">
          {capsules.map((capsule) => {
            ...
            return (
              ...
              >
                ...
                <div className={`text-xs font-bold px-2 py-1 rounded bg-cyan-500 text-white' : 'bg-slate-200 text-slate-600`}>
