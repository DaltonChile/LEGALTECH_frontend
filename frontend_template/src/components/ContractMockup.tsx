    ...
    <div className="relative">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-white">Arrendamiento</div>
              </div>
            </div>
            <div className="bg-lime-400/90 text-slate-900 text-xs px-3 py-1 rounded-full">
              Activo
            </div>
          </div>
        </div>
        ...
        <div className="p-6 space-y-4">
          <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg">
            ...
            <div className="flex-1">
              ...
              <div className="text-sm text-slate-900">María González</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg">
            ...
            <div className="flex-1">
              ...
              <div className="text-sm text-slate-900">12 meses</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg">
            ...
            <div className="flex-1">
              ...
              <div className="text-sm text-slate-900">$450.000 CLP</div>
            </div>
          </div>
        </div>
        
        <div className="px-6 pb-6">
          <button className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 text-white py-2.5 rounded-lg text-sm">
      ...
      <div className="absolute -top-4 -right-4 bg-white rounded-xl shadow-xl border border-slate-200 px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-slate-900">Listo en 5 min</span>
        </div>
      </div>
      ...
      <div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-xl border border-slate-200 px-4 py-3">
        ...
        <div className="text-2xl text-blue-600">2,847</div>
      </div>
    </div>
  );
}